...
// variable for the first two letters of countryAndRegion (AR in AR01)
// let countryCC = "XX";
// variable for the last two letters of countryAndRegion (01 in AR01)
// let regionCC = "";


// function getCountryCC() {
  // NOT NEEDED: jQuery grabs value
